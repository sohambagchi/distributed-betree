...
#ifndef ODYSSEY_OD_TOP_H
#define ODYSSEY_OD_TOP_H
...
typedef struct network_ts_tuple {
  uint32_t version;
  uint8_t m_id;
} __attribute__((__packed__)) netw_ts_tuple_t;
